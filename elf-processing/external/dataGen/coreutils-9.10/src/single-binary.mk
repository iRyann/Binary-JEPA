...
src_libsinglebin_md5sum_a_DEPENDENCIES = src/libsinglebin_cksum.a
src_libsinglebin_sha1sum_a_DEPENDENCIES = src/libsinglebin_cksum.a
src_libsinglebin_sha224sum_a_DEPENDENCIES = src/libsinglebin_cksum.a
src_libsinglebin_sha256sum_a_DEPENDENCIES = src/libsinglebin_cksum.a
src_libsinglebin_sha384sum_a_DEPENDENCIES = src/libsinglebin_cksum.a
src_libsinglebin_sha512sum_a_DEPENDENCIES = src/libsinglebin_cksum.a
# Command arch
...
src_libsinglebin_b2sum_a_SOURCES =   src/cksum.c src/blake2/blake2.h src/blake2/blake2-impl.h src/blake2/blake2b-ref.c src/blake2/b2sum.c src/blake2/b2sum.h
...
src_libsinglebin_basenc_a_ldadd =   $(LIBGMP)
...
src_libsinglebin_cksum_a_SOURCES =   $(src_b2sum_SOURCES) src/sum.c src/sum.h src/cksum_crc.c src/cksum_crc.h src/crctab.c
...
src_libsinglebin_md5sum_a_SOURCES = src/coreutils-md5sum.c
src_libsinglebin_md5sum_a_ldadd =   $(src_cksum_LDADD)  $(LIB_CRYPTO) src/libsinglebin_cksum.a
...
src_libsinglebin_sha1sum_a_SOURCES = src/coreutils-sha1sum.c
src_libsinglebin_sha1sum_a_ldadd =   $(src_cksum_LDADD)  $(LIB_CRYPTO) src/libsinglebin_cksum.a
...
src_libsinglebin_sha224sum_a_SOURCES = src/coreutils-sha224sum.c
src_libsinglebin_sha224sum_a_ldadd =   $(src_cksum_LDADD)  $(LIB_CRYPTO) src/libsinglebin_cksum.a
...
src_libsinglebin_sha256sum_a_SOURCES = src/coreutils-sha256sum.c
src_libsinglebin_sha256sum_a_ldadd =   $(src_cksum_LDADD)  $(LIB_CRYPTO) src/libsinglebin_cksum.a
...
src_libsinglebin_sha384sum_a_SOURCES = src/coreutils-sha384sum.c
src_libsinglebin_sha384sum_a_ldadd =   $(src_cksum_LDADD)  $(LIB_CRYPTO) src/libsinglebin_cksum.a
...
src_libsinglebin_sha512sum_a_SOURCES = src/coreutils-sha512sum.c
src_libsinglebin_sha512sum_a_ldadd =   $(src_cksum_LDADD)  $(LIB_CRYPTO) src/libsinglebin_cksum.a
...
src_libsinglebin_shred_a_ldadd =   $(GETHRXTIME_LIB)  $(FDATASYNC_LIB)
...
src_libsinglebin_sum_a_SOURCES =   src/sum.c src/sum.h src/cksum.c
...
src_libsinglebin_wc_a_ldadd =   $(wc_avx512_ldadd)  $(wc_avx2_ldadd)
