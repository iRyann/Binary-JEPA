...
Pour faire face à ce défi, la communauté scientifique et l'industrie se tournent massivement vers le développement d'outils automatisés propulsés par l'apprentissage automatique\footnote{Des précisions sur l'usage de telles solutions sont données en Annexe \ref{sub:IA et Cyberdéfense}} (\gls{ml} et \gls{dl}) \cite{artuso_thesis}.
