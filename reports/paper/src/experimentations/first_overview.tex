\subsection{Expérimentation 0 — Aperçu préliminaire : validation qualitative du pipeline}
\label{sub:exp0}
...
encodeur de type JEPA : (i) \emph{invariance à la compilation} — deux variants
compilés d'un même programme devraient être proches dans l'espace latent — et
(ii) \emph{séparabilité inter-programmes} — deux utilitaires de sémantique
...
qualitative. Elle ne vise pas à mesurer une performance absolue, mais à valider
