...
L'architecture apprend à prédire la représentation latente d'un bloc de code manquant en se basant sur son contexte. 
...
De plus, il serait irréaliste de prétendre capturer l'exhaustivité du comportement algorithmique d'un programme sur la seule base de son code statique. Néanmoins, cette contrainte de l'analyse statique est inhérente à notre démarche, car elle constitue l'essence même de la notion de hachage de fichier. Ce paradigme impose donc un double défi :
\begin{enumerate}
