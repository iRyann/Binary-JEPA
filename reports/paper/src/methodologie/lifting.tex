...
\subsubsection{Stabilité}\label{sec:Stabilité} % (fold)

\paragraph{Hypothèse}\label{par:Hypothèse} % (fold)
Modélisation offrant une résilience naturelle face aux obfuscations modifiant le graphe de contrôle (CFG).
% paragraph Hypothèse (end)% subsubsection Stabilité (end)
